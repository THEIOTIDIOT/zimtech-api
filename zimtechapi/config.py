...
class BaseConfig:
    ...
    SECURITY_LOGIN_ERROR_VIEW = "/redir/login-error"
    SECURITY_POST_CONFIRM_VIEW = "/redir/confirmed"
    SECURITY_CONFIRM_ERROR_VIEW = "/redir/confirm-error"
    SECURITY_RESET_VIEW = "/redir/reset-password"
    SECURITY_RESET_ERROR_VIEW = "/redir/reset-password-error"
